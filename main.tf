# A module which creates AWS infrastucture for serving a static
# website
#
# It creates:
#
...
#
# DNS configuration and publishing the website are left for the user
# and are not a scope of this module.
#
